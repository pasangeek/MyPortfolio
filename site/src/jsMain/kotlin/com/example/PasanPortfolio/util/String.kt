...
class String {
    val NAME = "Pasan Wedikkara"
    val PROFESSION = "Kotlin Multiplaform Developer"
    val ABOUT_ME =
    ...
    val BUTTON_TEXT = "Get in touch"
    val MY_EMAIL = "pasanwedikkara@gmail.com"
    val SAVED_THEME = "theme"
}